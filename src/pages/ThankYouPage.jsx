...
const ThankYouPage = () => {
  ...
  return (
    <>
      {/* SEO Head */}
      <SEOHead
        title="Thank You - Historivin | Order Confirmation"
        description="Thank you for your purchase! Your vehicle history report from Historivin is being prepared and will be delivered to your email within minutes."
        keywords="historivin, order confirmation, vehicle history report, VIN check, thank you"
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="info-card" style={{
                      ...
                      <p style={{ color: '#999', fontSize: '0.9rem', margin: '0' }}>
                        Email: support@historivin.com<br />
